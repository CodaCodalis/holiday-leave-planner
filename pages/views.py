...
class HomePageView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['teams_with_conflict'] = self.find_conflicts(self.teams, self.users, self.vacations)
    ...
    def find_conflicts(cls, teams, users, vacations):
        ...
        for team in teams:
            ...
            for user in users:
                if team == user.team:
                    teammembers += 1
            # für jeden urlaubseintrag die anzahl der mitglieder ermitteln, die an gleichen tag urlaub genommen haben
            ...
            for vacation in vacations:
                ...
                for processed_delta in range(0, vacation_days+1):
                    ...
                    # if vacationers_on_processed_date > 0 and 1 - (vacationers_on_processed_date / teammembers) < float(min_att) / 100:
                    if True:
                        teams_with_conflict.append(team)
                        break

        return teams_with_conflict
